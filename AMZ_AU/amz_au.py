            ...
            if bonjour_name in html:
                ...
                if key_word == 'Mit':
                    try:
                        ...
                        detail_node = dr.find_element_by_xpath(
                            '//*[@id="search"]/div[1]/div[2]/div/span[3]/div[1]/div[4]/div/div/div/div[2]/div[2]/div/div[1]/div/div/div/h5/a')
                        detail_node.click()
                    finally:
                    ...
                    try:
                        ...
                        detail_node = dr.find_element_by_xpath(
                            '//*[@id="search"]/div[1]/div[2]/div/span[3]/div[1]/div[5]/div/div/div/div[2]/div[2]/div/div[1]/div/div/div/h5/a')
                        detail_node.click()
                    finally:
                        self.like_car(dr, amil_num)
...
if __name__ == '__main__':
    q = getinfo.GetInfo('reged_au').get_no("<> 1")
    ...
    x = 0
    for i in loops:
        thread = Thread(target=run, args=(q, y, x))
